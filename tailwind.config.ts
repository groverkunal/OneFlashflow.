  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        headline: ['Inter', 'sans-serif'], // Use Inter for headlines
        body: ['Inter', 'serif'],       // Use Inter for body, serif fallback
        code: ['monospace'],
      },
      colors: {
      ...
      animation: {
        ...
        'flashcard-slide-in': 'slide-in 0.3s ease-out forwards',
        'flashcard-slide-out': 'slide-out 0.3s ease-in forwards',
      },
    },
  },
